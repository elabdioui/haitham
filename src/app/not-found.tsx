...
// Custom SEO component since we're in a client component
function NotFoundSEO() {
  return (
    <Head>
      <title>Page Not Found | Haitham El Abdioui</title>
...
export default function NotFound() {
  ...
  // Only run glitch effect on client
  useEffect(() => {
    setIsClient(true);
