...
export default function About() {
    return (
      ...
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-white mb-16 text-center"> <FlipText>About Me</FlipText></h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <p className="text-gray-400">Graduated in [Your Degree]</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <h4 className="text-xl font-semibold text-white mb-2">Currently</h4>
              <p className="text-gray-400">Full Stack Developer at [Company]</p>
            </div>
            ...
            <div className="md:col-span-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <p className="text-gray-400 leading-relaxed">
                Passionate about web development for over [X] years, I specialize in creating modern and efficient applications. I enjoy solving complex problems and learning new technologies to create exceptional user experiences.
              </p>
            </div>
          </div>
        </div>
