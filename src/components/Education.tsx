   ...
   
    {
      ...
      content: (
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
          ...
          <p className="text-gray-300 text-sm leading-relaxed mb-3">
            Earned a scientific baccalaureate with honors, specializing in physical sciences. 
            Developed strong analytical and problem-solving skills through rigorous coursework in 
            advanced mathematics, physics, and computer science fundamentals.
          </p>
        </div>
      ),
    },
